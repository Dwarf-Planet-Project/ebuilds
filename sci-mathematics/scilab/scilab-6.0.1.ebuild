...
IUSE="bash-completion debug doc emf fftw +gui +matio mpi nls openmp
	static-libs test tk +umfpack +xcos linguas_de linguas_de_DE 
	linguas_sv linguas_sv_SE linguas_en_GB linguas_en linguas_bn 
	linguas_bn_IN linguas_fr_FR linguas_pt_BR linguas_ja_JP 
	linguas_ru_RU"
...
#		"${FILESDIR}/${PN}-5.5.2-fix-random-runtime-failure.patch" \
#		"${FILESDIR}/${PN}-5.5.2-accessviolation.patch" \
#		"${FILESDIR}/${PN}-5.5.2-missinglib.patch" \
#		"${FILESDIR}/${PN}-5.5.2-batik-1.8.patch" \
#		"${FILESDIR}/${PN}-5.5.2-fop-2.0.patch" \
#		"${FILESDIR}/${PN}-5.5.2-xmlgraphics-common-2.0.patch" \
#		"${FILESDIR}/${PN}-5.5.2-freehep.patch"
