...
SRC_URI="mirror://sourceforge/${MY_PN}/ProjectLibre/$(get_version_component_range 1-2)/${MY_P}.tar.gz
	https://sourceforge.net/p/projectlibre/code/ci/master/tree/openproj_build/resources/${MY_PN}.desktop?format=raw -> ${MY_PN}.desktop
	https://sourceforge.net/p/projectlibre/code/ci/master/tree/openproj_build/resources/${MY_PN}.png?format=raw -> ${MY_PN}.png"
